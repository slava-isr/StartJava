...
public class VariableNamesTheme {
    ...
    public static void main(String[] args) {
        ...
        // Процент по вкладу
        double depositInterestRate = 7.8;
        ...
        int hddCapacity = 1024; // В гигабайтах
        System.out.println("Емкость HDD = " + hddCapacity + " GB");
        ...
        char asciiChar = 'A';
        System.out.println("Символ ASCII = " + asciiChar);
    }
}
